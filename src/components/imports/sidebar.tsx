...
import { Button } from "@/components/imports/button"
import { Input } from "@/components/imports/input"
import { Separator } from "@/components/imports/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@/components/imports/sheet"
import { Skeleton } from "@/components/imports/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@/components/imports/tooltip"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {state === "expanded" ? <CaretLeftIcon size={18} /> : <CaretRightIcon size={18} />}
